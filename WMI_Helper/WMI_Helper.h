...
public:
	...
	//	autoconnect - The whether or not the WMI_Helper auto-connects and retries information. 
	//				  If this value is false, the user must call <connect> later. (default value of true)
	//
	//Exceptions:
	//	std::exception - Thrown if any errors occur during the <connect> stage if autoconnect was set to true
